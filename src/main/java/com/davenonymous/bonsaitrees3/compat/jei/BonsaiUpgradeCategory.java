...
public class BonsaiUpgradeCategory implements IRecipeCategory<BonsaiUpgradeWrapper> {
    ...
    @Override
    public void draw(BonsaiUpgradeWrapper recipe, IRecipeSlotsView view, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    	recipe.draw(view, guiGraphics, mouseX, mouseY);
    }
