...
public class BonsaiRecipeCategory implements IRecipeCategory<BonsaiRecipeWrapper> {
	...
	@Override
    public void draw(BonsaiRecipeWrapper recipe, IRecipeSlotsView view, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    	recipe.draw(view, guiGraphics, mouseX, mouseY, this.guiHelper);
    }
